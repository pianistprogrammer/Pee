    ...
    install: function install(Vue, installOptions) {
        Vue.directive('tooltip', {
            bind: function bind(el, binding, vnode) {
                if (installOptions) {
                    _tooltip2.default.defaults(installOptions);
                }
            },
...
function filterBindings(binding) {
    var delay = !binding.value || isNaN(binding.value.delay) ? _tooltip2.default._defaults.delay : binding.value.delay;
    ...
    return {
        ...
        offset: binding.value && binding.value.offset ? binding.value.offset : _tooltip2.default._defaults.offset,
        delay: delay
    };
}
...
function getClass(_ref3) {
    ...
    } else if (_tooltip2.default._defaults.class) {
        return BASE_CLASS + ' ' + _tooltip2.default._defaults.class;
    } else {
        return BASE_CLASS;
    }
}
